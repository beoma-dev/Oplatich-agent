...
HELP_TEXT = (
    ...
    "суммам. И то и другое НЕОБЯЗАТЕЛЬНО: «оплатить по договору, документы "
    "будут позже» — тоже заявка. Договор, спецификацию и прочее приложите "
    "в <b>дополнительные документы</b> — их можно несколько.\n\n"
    "3️⃣ Заполните поля:\n"
    ...
    "• <b>Срок исполнения работ по договору</b> — датой или словами "
    ...
    "уведомление;\n"
    "• <b>⏰ Напомнить</b> (в форме) — у просроченной заявки: финансисты "
    "получат сообщение, что срок прошёл; повторить можно через шесть часов;\n"
    "• <b>📄 Акт / УПД</b> (в форме) — приложить закрывающие документы "
    "к уже оплаченной заявке, хоть через месяц.\n\n"
    "<b>Полезное</b>\n"
