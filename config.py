...
class Settings(BaseSettings):
    ...
    # Живая инструкция вместо простыни текста. Пока обкатывается на
    # стенде: выключено — экран «Инструкция» остаётся прежним текстовым.
    animated_help: bool = Field(False, alias="ANIMATED_HELP")
